...
# # the element
# # websites = [{'url': 
# 'https://www.youtube.com/live/bkvaeX5EoUs?feature=share',
# # 'selector': '#cinematics'},
# # chrome_driver_path = (
# #     "/home/sofia_afn/.cache/selenium/chromedriver-linux64/chromedriver.exe"
# # )
# website = {
#     "url": 
# "https://www.youtube.com/watch?v=v7wWIO7brSM&ab_channel=BredbandiKristianstadAB"
# }
...
# # Now, you can continue using the driver for your automation tasks
...
#         # Find the element
#         element = driver
# .find_element(By.CSS_SELECTOR, "#cinematics")

#         # Take screenshot of the 
# element and save it with the current timestamp
#         timestamp = time.strftime("%d%m-%H%M")
#         element.screenshot(f"{directory}/Kris-{timestamp}.png")
...
# seconds until the next screenshot.")
...
# screenshots you want to capture in 24 hours
total_screenshots = 30  # Adjust this number as needed
screenshots_taken = 0

# Set the start time and end time
# for the 24-hour period (in seconds since epoch)
...
while screenshots_taken < total_screenshots:
    try:
        ...
        timestamp = time.strftime("%d%m-%H%M")
        screenshot_filename = f"{directory}/Kris-{timestamp}.png"
